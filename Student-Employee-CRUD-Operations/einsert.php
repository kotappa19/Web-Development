...
<form method="POST" class="was-validated" action="" >
  ...
  <div class="mb-3">
    ...
    <input type="number" class="form-check-input" id="validationFormCheck1" placeholder="Employee Number" name="roll" required>
    ...
    <input type="number" class="form-check-input" id="validationFormCheck1"  placeholder="Salary" name="s1" required>
    <div class="invalid-feedback">
   ...
   <br><br>
    ...
    if(isset($_POST['submit']))
    {
        ...
        $snam=$_POST['nam'];
        $sb1=$_POST['s1'];
        $sql = "INSERT INTO `emp` (`empno`, `ename`, `esalary`) VALUES ('$sroll', '$snam', '$sb1')";
        if (mysqli_query($conn, $sql)) {
            echo '<script>alert("Employee details added Successfully")</script>';
    } else {
      echo '<script>alert("Employee already Found")</script>';
    }
    }

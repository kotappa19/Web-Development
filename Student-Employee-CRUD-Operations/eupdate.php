...
<body>
    ...
    <nav class="navbar navbar-dark bg-dark" >
      ...
      <div class="navbar navbar-dark bg-dark" id="form-parameters">
       ...
       <form class="was-validated" method="POST" action="etupdate.php">
  ...
  <div class="mb-3">
    ...
    <input type="number" class="form-check-input" id="validationFormCheck1" name="roll" placeholder="Employee Number"  required>

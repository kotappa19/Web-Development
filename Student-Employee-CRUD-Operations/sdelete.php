...
<form method="POST" class="was-validated" action="">
  ...
  <div class="mb-3">
    ...
    if(isset($_POST['submit'])){
        $rolno = $_POST['roll'];
        $sql = "SELECT * FROM mark WHERE rollno = '$rolno'";
    ...
    <center><h4 style="font-family:-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Oxygen, Ubuntu, Cantarell, 'Open Sans', 'Helvetica Neue', sans-serif" >Do you wish to delete the data of the above Student??</h4></center>
        <table style="margin-left: 37%;">
            <tr>
                <td><a href="stdelete.php? id= <?php echo $row['rollno'];?>" class="btn btn-primary btn-sm">Yes</a></td>
                <td><a href="stdelete.php? id= <?php echo 0;?>" class="btn btn-secondary btn-sm" style="margin-left: 195px;">No</a></td>
            </tr>
        </table>
    </div>
    </form>
                ...
                echo '<script>alert("Student with Roll No: '.$rolno.' is not present")</script>';
            }
        }
?> 
      <footer>
